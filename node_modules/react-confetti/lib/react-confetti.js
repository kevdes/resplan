/*! react-confetti - 2.0.2 | (c) 2015, 2017  Aaron Lampros <alampros@gmail.com> | MIT | https://github.com/alampros/react-confetti#readme */
...
var _confetti = __webpack_require__(11);
...
var Confetti = function (_React$PureComponent) {
  ...
  _createClass(Confetti, [{
    ...
    value: function componentDidMount() {
      this.confetti = (0, _confetti2.default)(this.canvas).numberOfPieces(this.props.numberOfPieces).confettiSource(this.props.confettiSource).friction(this.props.friction).wind(this.props.wind).gravity(this.props.gravity).colors(this.props.colors).opacity(this.props.opacity).recycle(this.props.recycle).run(this.props.run)();
    }
  }, {
...
function confetti(canvas) {
  ...
  self.run = function () {
    ...
    var wasRunning = run;
    run = arguments.length <= 0 ? undefined : arguments[0];
    if (!wasRunning && run) {
      self.update();
    }
    return self;
